...
network='Slashdot' #'Epinions'

args = DotMap(
    train_file_folder='{}/trains_Augmentation'.format(network), # trains_Augmentation
    test_file_path='{0}/tests/{0}-test-5.csv'.format(network),
    num_layers=2,
    channels=64,
    lr=1e-2,
    epochs=300,
...
if __name__ == '__main__':
    ...
    print(results)
    collect_results(results, save_res=True, suffix='elec-random')
